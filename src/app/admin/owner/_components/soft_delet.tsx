...
const SoftDeleteOwner= ({ id }: { id: number }) => {
 ...
 mutate (`http://localhost:4000/owners?q=`);
  ...
  const handleDelete = async () => {
    try {
      ...
      const response = await axios.delete(`http://localhost:4000/owners/${id}`);
      ...
      if (error instanceof z.ZodError) {
        ...
        console.error("gagal hapus Departement", error);
      }
    }
  }
...
export default SoftDeleteOwner;
